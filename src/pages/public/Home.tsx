...
const Home = () => {
  ...
  const serviceDetails = {
    ...
    loans: {
      ...
      features: [
        { icon: <HomeIcon className="w-5 h-5" />, text: "Home Loans" },
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>
          Prince Group - Professional Document & Loan Solutions in Kanyakumari
          District
        </title>
        <meta
          name="description"
          content="Prince Group offers trusted document registration and loan services across 20+ branches in Kanyakumari District. Same-day processing, expert guidance, and competitive rates."
        />
        <meta
          name="keywords"
          content="document registration, loan services, Kanyakumari, property registration, legal documentation, business loans, personal loans, home loans"
        />
        <meta
          property="og:title"
          content="Prince Group - Documentation & Loan Services in Kanyakumari"
        />
        <meta
          property="og:description"
          content="Trusted documentation and financial solutions with 20+ branches across Kanyakumari District since 2018."
        />
              ...
              >
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-700">
                    Trusted by 30000+ Customers
                  </span>
                </motion.div>

                <h1 className="text-4xl lg:text-4xl font-bold text-gray-900 mb-6">
                  Document, Loan & Revenue Services in Kanyakumari
                </h1>

                <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
                  <span className="block mt-2 bg-gradient-to-r from-[#4eb4a7] to-[#85cbc3] bg-clip-text text-transparent">
                ...
                <p className="text-lg text-gray-600 mb-8">
                  Expert document registration and loan services across 20+
                  branches in Kanyakumari District. Same-day processing,
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {serviceDetails[selectedService].features.map(
                        (feature, index) => (
                          <motion.div
                            key={index}
                          ...
                          >
                            <div
                              className={`p-2 rounded-lg bg-gradient-to-r ${serviceDetails[selectedService].color} text-white`}
                            >
                              {feature.icon}
                            </div>
                            <span className="text-sm font-medium text-gray-700">
              ...
              >
                ...
                <div className="relative">
                  ...
                  >
                    {/* Card Header */}
                    <div
                      className={`p-8 bg-gradient-to-r ${serviceDetails[selectedService].color}`}
                    >
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-4">
                            <div className="text-3xl font-bold">
                              {serviceDetails[selectedService].stats.value}
                            </div>
                            <div className="text-sm opacity-90">
                              {serviceDetails[selectedService].stats.label}
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          {selectedService === "documentation" ? (
                            ...
                            <div className="space-y-4">
                              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                <div className="flex items-center gap-3">
                                  <HomeIcon className="w-6 h-6 text-[#60afb4]" />
                                  <span className="font-medium">
                                    Home Loans
                                  </span>
                                </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#4eb4a7]/10 to-[#85cbc3]/10 px-6 py-2 rounded-full mb-6">
                <Sparkles className="w-4 h-4 text-[#4eb4a7]" />
                <span className="text-sm font-bold text-[#4eb4a7] uppercase tracking-wide">
                  Why Choose Us
                </span>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                Prince Group's Trusted
                <span className="bg-gradient-to-r from-[#4eb4a7] to-[#85cbc3] bg-clip-text text-transparent">
                  {" "}
                  Documentation Excellence
                </span>
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Since 2018, Prince Group has become the most trusted name in
                Kanyakumari District for document registration and loan
                services, with over 33,500+ successful document registrations
                and ₹40 crore in loan disbursements.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    "Trusted by thousands across Kanyakumari for reliable document processing and loan services",
                  color: "from-[#4eb4a7] to-[#60afb4]",
                  delay: 0,
                  animation: {
                    type: "pulse",
                ...
                },
                {
                  ...
                  description:
                    "Extensive coverage with convenient branches throughout Kanyakumari District for easy document registration",
                  color: "from-[#60afb4] to-[#85cbc3]",
                  delay: 0.1,
                  animation: {
                    type: "bounce",
                ...
                },
                {
                  ...
                  description:
                    "Fast document registration and loan approvals with efficient same-day processing systems",
                ...
                },
                {
                  ...
                  description:
                    "Government authorized documentation services with complete legal compliance and transparency",
                ...
                >
                  <div className="relative h-full bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
                    ...
                    <div
                      className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.color} p-0.5 mb-4 relative`}
                    >
                      ...
                      <motion.div
                        ...
                        animate={
                          feature.animation?.type === "pulse"
                            ? {
                                boxShadow: [
                                  "0 4px 6px rgba(78, 180, 167, 0.3)",
                                  "0 8px 15px rgba(78, 180, 167, 0.6)",
                                  "0 4px 6px rgba(78, 180, 167, 0.3)",
                                ],
                              }
                            : feature.animation?.type === "bounce"
                            ? {
                                y: [0, -5, 0],
                                boxShadow: [
                                  "0 4px 6px rgba(78, 180, 167, 0.3)",
                                  "0 8px 15px rgba(78, 180, 167, 0.5)",
                                  "0 4px 6px rgba(78, 180, 167, 0.3)",
                                ],
                              }
                            : feature.animation?.type === "spin"
                            ? {
                                rotate: [0, 45, 0],
                                borderRadius: ["0.5rem", "1rem", "0.5rem"],
                              }
                            : feature.animation?.type === "ping"
                            ? {
                                scale: [1, 1.1, 1],
                                boxShadow: [
                                  "0 0 0 0 rgba(78, 180, 167, 0)",
                                  "0 0 0 8px rgba(78, 180, 167, 0.3)",
                                  "0 0 0 0 rgba(78, 180, 167, 0)",
                                ],
                              }
                            : {}
                      ...
                      >
                        <motion.div
                          animate={
                            feature.animation?.type === "pulse"
                              ? { scale: feature.animation.scale }
                              : feature.animation?.type === "bounce"
                              ? { y: feature.animation.y }
                              : feature.animation?.type === "spin"
                              ? { rotate: feature.animation.rotate }
                              : feature.animation?.type === "ping"
                              ? {
                                  opacity: feature.animation.opacity,
                                  scale: feature.animation.scale,
                                }
                              : {}
                          }
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                Choose from our comprehensive range of legal document
                registration services and flexible loan options tailored to meet
                your specific needs with expert guidance
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    "Comprehensive document registration and legal paperwork assistance with government compliance",
                  features: [
                  ...
                  image:
                    "/lovable-uploads/43081f16-3e26-46ee-bec6-e85ef9aadbbc.png",
                ...
                },
                {
                  ...
                  description:
                    "Customized financial solutions with competitive interest rates and simplified approval process",
                  features: [
                    "Personal & Home Loans",
                  ...
                  image:
                    "/lovable-uploads/f4f5c039-d495-44e1-83bd-cc24c888ca39.png",
                    ...
                    <div className="p-8">
                      ...
                      <div className="space-y-3 mb-6">
                        {service.features.map((feature, idx) => (
                          <motion.div
                            ...
                            transition={{
                              duration: 0.3,
                              delay: service.delay + 0.1 + idx * 0.05,
                            }}
                          >
                            <div
                      ...
                      <div className="bg-gray-50 rounded-xl p-4 mb-6">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-lg font-bold text-[#4eb4a7]">
                            {service.stats.value}
                          </span>
                        </div>
                      </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                ...
                <span className="bg-gradient-to-r from-[#4eb4a7] to-[#85cbc3] bg-clip-text text-transparent">
                  {" "}
                  Kanyakumari Clients Say
                </span>
              </h2>
              <p className="text-lg text-gray-600">
                Read genuine success stories from Kanyakumari residents who
                trusted Prince Group for their documentation and loan
                requirements
              </p>
            </motion.div>
            ...
            <div className="relative max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  {
                    quote:
                      "Prince Group handled my property registration with exceptional efficiency. Their team's expertise in documentation services saved me significant time and money in Kanyakumari District.",
                    author: "Sneha Patel",
                  ...
                  {
                    quote:
                      "I received my business loan approval within just 5 days! Prince Group offers the most competitive interest rates in Kanyakumari with flexible repayment terms for entrepreneurs.",
                    author: "Priya Nair",
                  ...
                  {
                    quote:
                      "As a loyal customer for over 5 years, I've relied on Prince Group for multiple documentation and loan services. Their consistent professionalism and expertise is unmatched in Kanyakumari.",
                    author: "Mohammed Ali",
                    ...
                    <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 h-full relative overflow-hidden">
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        <div className="bg-gradient-to-r from-[#4eb4a7]/10 to-[#85cbc3]/10 px-3 py-1 rounded-full">
                          <span className="text-xs font-medium text-[#4eb4a7]">
                            {testimonial.service}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-1 mb-4">
                        {[...Array(testimonial.rating)].map((_, i) => (
                          <motion.svg
                            ...
                            whileInView={{ opacity: 1, scale: 1 }}
                            transition={{
                              delay: testimonial.delay + 0.1 + i * 0.05,
                            }}
                          >
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                ...
                <span className="bg-gradient-to-r from-[#4eb4a7] to-[#85cbc3] bg-clip-text text-transparent">
                  {" "}
                  20+ Branches in Kanyakumari
                </span>
              </h2>
              <p className="text-lg text-gray-600">
                Visit your nearest Prince Group branch in Kanyakumari District
                for expert document registration services and personalized loan
                consultations
              </p>
            </motion.div>
                  ...
                  {[
                    {
                      ...
                      phone: "9489359755",
                      address:
                        "Near Thingal Nagar Sub-Register office, Anbu Complex 1st Floor, Thingal Nagar",
                    },
                    {
                      name: "Rajakkamangalam Branch",
                      phone: "8300933178",
                      address:
                        "Near Rajakkamangalam Sub-Register Office No. 11/14, Saraswathi Nathan Complex, Ganapathipuram 629502",
                    },
                    {
                      name: "Kanyakumari Branch",
                      phone: "9150537718",
                      address:
                        "Door no 3B/1, SLB South Street, Near Mutharamman Temple, Nagercoil",
                    },
                    {
                      name: "Palugal Branch",
                      phone: "9361073196",
                      address:
                        "Opposite Palugal Sub-Register Office, Koonampana Market, Koonampana",
                    },
                    {
                      name: "Verlilambi Branch",
                      phone: "7339070114",
                      address:
                        "Opposite to fish Market, Near Verkilambi Register Office, Mallanvillai, Verkilambi, 629166",
                    },
                    {
                      name: "Karungal Branch",
                      phone: "9384170178",
                      address:
                        "Opposite Royal Enfield Service Showroom 1st Floor, Karungal",
                    },
                    {
                      name: "Thiruvattar Branch",
                      phone: "9789499178",
                      address:
                        "Sindhu Kumar Building, 1st floor, Beside Thanumalayan Hotel, Thiruvattar",
                    },
                    {
                    ...
                    },
                    {
                      ...
                      phone: "9566909178",
                      address:
                        "No 21/133/5, Opposite Palliyadi Sub-Register Office, Alanthurai, Palliyadi",
                    },
                    {
                      name: "Manavalakurichy Branch",
                      phone: "8220594178",
                      address:
                        "Near Manavalakurichy Sub-Register Office, Opposite to Lakshmipuram College Ground, Lakshmipuram",
                    },
                    {
                      name: "Colachel Branch",
                      phone: "9363916484",
                      address:
                        "Opposite Colachel Sub-Register Office, Near David Driving School, Colachel, 629251",
                    },
                    {
                      name: "Edalagudi Branch",
                      phone: "9363914982",
                      address:
                        "Near Edalagudi Sub-Register Office, Opposit to Government High School, Jaganathan Complex, 1st floor, Edalagudi",
                    },
                    {
                      name: "Boothapandi Branch",
                      phone: "7448975519",
                      address:
                        "Opposite to National Highway Office, Gerome Complex, Ist Floor, Boothapandi",
                    },
                    {
                    ...
                    },
                    {
                      ...
                      phone: "8681980178",
                      address:
                        "Opposite to Munjirai Sub-Register Office, Munjirai",
                    },
                    {
                      name: "Thovalai Branch",
                      phone: "9150537718",
                      address:
                        "Near Thovalai Sub Register Office, Sister Complex, 1st Floor, Main Road, Thovalai 629302",
                    },
                    {
                      name: "Arumanai Branch",
                      phone: "9150537718",
                      address:
                        "Beside Arumanai Sub-Register Office, Punniyam, Arumanai",
                    },
                    {
                      name: "Thuckalay Branch",
                      phone: "9600303653",
                      address:
                        "Opposite to Thaluk Office, Near Anna Statue, Market Road, Thuckalay",
                    },
                  ].map((branch, index) => (
                    <motion.div
                      key={index}
                  ...
                  {[
                    {
                      ...
                      description:
                        "Fully licensed for legal document registration services in Kanyakumari",
                    },
                    {
                      icon: <Lock className="h-6 w-6" />,
                      title: "Data Security",
                      description:
                        "Secure document processing with confidential information protection",
                    },
                    {
                      icon: <Database className="h-6 w-6" />,
                      title: "Digital Infrastructure",
                      description:
                        "Advanced document management system for efficient processing",
                    },
                    {
                      icon: <Cpu className="h-6 w-6" />,
                      title: "Tech-Enabled",
                      description:
                        "Modern loan application tracking and document registration updates",
                    },
                  ].map((item, idx) => (
                    <motion.div
                      key={idx}
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="px-6 py-16 md:p-16 text-center relative z-10">
                ...
                >
                  Join 30000+ satisfied customers who trust Prince Group for
                  reliable document registration and loan services across
                  Kanyakumari District. Same-day processing available.
                </motion.p>
                <motion.div
                ...
                >
                  <Button
                    asChild
                    className="bg-white text-[#4eb4a7] hover:bg-gray-100 px-8 py-6 text-lg flex items-center gap-2 rounded-full shadow-lg hover:shadow-xl"
                  >
                    <Link to="/membership">
                      Register for Services <ArrowRight className="ml-1" />
                    </Link>
                  </Button>
                </motion.div>
              </div>
