...
const EventTicketBanner = () => {
  ...
  const typingSpeed = 40; // faster typing speed (was 50)
  const pauseDuration = 1500; // shorter pause between messages (was 2000)
  
  // Handle typing animation - completely rewritten for reliability
  useEffect(() => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-[60px] sm:h-[50px] w-full bg-gradient-to-r from-purple-900 via-indigo-800 to-purple-800 text-white z-[1001] border-b-2 border-pink-500 shadow-xl overflow-hidden">
